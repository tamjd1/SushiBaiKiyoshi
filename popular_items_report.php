...
$conn = db_connect();
//$sql =  "SELECT \"tblMenuItems\".\"ItemID\", \"ItemDescription\", \"ItemQuantity\"
//  FROM \"tblMenuItems\" JOIN \"tblInvoiceItems\"
//  ON \"tblMenuItems\".\"ItemID\" = \"tblInvoiceItems\".\"ItemID\"
//  WHERE \"tblMenuItems\".\"ItemID\" = '" . $id . "'";

$sql = "SELECT \"ItemDescription\", \"ItemQuantity\"
  FROM \"tblMenuItems\" JOIN \"tblInvoiceItems\" ON \"tblMenuItems\".\"ItemID\" = \"tblInvoiceItems\".\"ItemID\"";
...
<section class="center">
    <h3>Most Frequently Bought Items Overall</h3>    
